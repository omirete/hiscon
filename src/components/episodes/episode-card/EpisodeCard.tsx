...
import Episode from "../../../types/spotify/Episode";

function EpisodeCard(props: { episodeData: Episode }) {
    ...
    const formatted_release_date =
        release_day + " de " + months[release_month - 1] + ", " + release_year;

    const name = EPISODE_DATA.name;
    const description = EPISODE_DATA.description;

    const desc_elem_ref = useRef<HTMLDivElement>(null);
    const desc_button_ref = useRef<HTMLDivElement>(null);
        ...
        <div className="episode-card">
            ...
            <div className="episode-information">
                ...
                <div
                    ref={desc_elem_ref}
                    className={
                        "description" + (flagExpandDesc ? " expanded" : "")
                    }
                >
                    {description}
                </div>
