...
import "./NavBar.css";
import logo_texto_blanco from "../../../assets/logo-texto-blanco.svg";
...
function NavBar() {
    ...
    return (
        <div className="navbar">
            <header
                className={"navbar-content" + (flagScrolled ? " scrolled" : "")}
            >
                <div className="flex-item left-aligned">
                    <div className="logo">
                        <a href="#home">
                            <img
                                src={logo_texto_blanco}
                ...
                <div className="flex-item right-aligned">
                    <div className="social-buttons">
                        <div className="big-social-buttons">
                            <a href="https://open.spotify.com/show/7uarSUYpISt1SBIGGitQFi">
                    ...
                    <Hamburger size={32} onClick={toggleMenu} />
                </div>
            </header>
