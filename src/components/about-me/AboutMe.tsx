...
function ProfilePictureCarousel() {
            ...
            <div className="about-me-content about-me-flexbox">
                <div className="flex-item about-me-text">
                    ...
                    <div className="about-me-description">
                        <p>
                            Me llamo Julieta Morales. Mi posición sexual
                            favorita es yo arriba y abajo el patriarcado. Nací
                            en Argentina, soy Comunicadora Social y tengo un
                            Master en Género. Y, si bien trabajo como periodista
                            y para organizaciones de Derechos Humanos, lo que
                            más me gusta hacer es hablar sobre la concha.
                        </p>
                    </div>
                </div>
                {/* <ProfilePicture /> */}
